...
assert.ok(gsTimeoutMsForBytes(40 * MB, {}) > 180_000, "40MB PDFs need more time for slow Render instances");
assert.ok(gsTimeoutMsForBytes(40 * MB, {}) <= MAX_ADAPTIVE_GS_TIMEOUT_MS);
assert.strictEqual(gsTimeoutMsForBytes(40 * MB, { GS_TIMEOUT_MS: "600000" }), 600_000);
