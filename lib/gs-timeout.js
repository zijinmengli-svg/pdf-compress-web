...
const MAX_ADAPTIVE_GS_TIMEOUT_MS = 10 * 60 * 1000;
// Image-heavy design PDFs can be expensive well below 20MB. The 10.8MB
// production failure showed that the old threshold still killed valid files.
const ADAPTIVE_START_MB = 8;
const ADAPTIVE_START_TIMEOUT_MS = 180 * 1000;
const ADAPTIVE_PER_MB_MS = 5 * 1000;
const MB = 1024 * 1024;
