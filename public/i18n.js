(function exposeTinyPdfI18n(root, factory) {
  ...
  const messages = {
    en: {
      ...
      websiteSessionRequired: "Please refresh TinyPDF and try again.",
      ...
      referralKicker: "Free compression credits",
      referralTitle: "Share TinyPDF with a friend",
      referralDescription: "When a new friend completes their first compression and downloads the result, you both receive 1 free compression.",
      referralBalanceLabel: "Your available credits",
      referralCopy: "Copy invite link",
      referralShare: "Share invite link",
      referralCopied: "Invite link copied",
      referralShared: "Invite link ready to share",
      referralShareUnavailable: "Sharing is unavailable here. The invite link was copied instead.",
      referralExpiry: "Earliest expiry: {date}",
      referralNoExpiry: "Credits expire individually after 90 days.",
    },
    "zh-CN": {
      compressButton: "开始压缩",
      compressing: "正在压缩…",
      ...
      websiteSessionRequired: "请刷新 TinyPDF 页面后重试。",
      rasterizedNote: "为尽量接近目标大小，页面已转为图片，清晰度可能会降低。",
      metricOriginal: "原文件大小",
      metricTarget: "目标大小",
      metricResult: "压缩后大小",
      metricRatio: "压缩比例",
      referralKicker: "免费压缩次数",
      referralTitle: "分享 TinyPDF 给好友",
      referralDescription: "好友首次压缩成功并下载结果后，你和好友各获得 1 次免费压缩。",
      referralBalanceLabel: "当前可用次数",
      referralCopy: "复制邀请链接",
      referralShare: "分享邀请链接",
      referralCopied: "邀请链接已复制",
      referralShared: "邀请链接已准备好分享",
      referralShareUnavailable: "当前设备不支持系统分享，已改为复制邀请链接。",
      referralExpiry: "最早到期：{date}",
      referralNoExpiry: "每次获得的次数自获得之日起 90 天后分别到期。",
    },
  };
